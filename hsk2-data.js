/* ============================================================
   hsk2-data.js  (النسخة النهائية المدمجة - الدروس 1 إلى 10)
   تطبيق Taallim Chinese - مستوى HSK2
   ============================================================ */

const HSK2_LESSONS = [

/* ------------------ الدرس 1: الزمن الماضي ------------------ */
{
  id: 1,
  level: "HSK2",
  title: "الزمن الماضي",
  ...
  words: [
    { id:"v101", hanzi:"了", pinyin:"le", meaning_ar:"أداة اكتمال الفعل (زي 'قد' في الماضي)", audio:"audio/hsk2/l01/v101.wav",
      example:{ hanzi:"我吃了饭。", pinyin:"wǒ chī le fàn", meaning_ar:"أنا أكلت الأكل." } },
    { id:"v102", hanzi:"昨天", pinyin:"zuótiān", meaning_ar:"إمبارح", audio:"audio/hsk2/l01/v102.wav",
      example:{ hanzi:"我昨天去了学校。", pinyin:"wǒ zuótiān qù le xuéxiào", meaning_ar:"أنا رحت المدرسة إمبارح." } },
    { id:"v103", hanzi:"以前", pinyin:"yǐqián", meaning_ar:"قبل كده / زمان", audio:"audio/hsk2/l01/v103.wav",
      example:{ hanzi:"我以前不会说中文。", pinyin:"wǒ yǐqián bú huì shuō zhōngwén", meaning_ar:"زمان ماكنتش بعرف أتكلم صيني." } },
    { id:"v104", hanzi:"去年", pinyin:"qùnián", meaning_ar:"السنة اللي فاتت", audio:"audio/hsk2/l01/v104.wav",
      example:{ hanzi:"去年我去了中国。", pinyin:"qùnián wǒ qù le zhōngguó", meaning_ar:"السنة اللي فاتت رحت الصين." } },
    { id:"v105", hanzi:"上个月", pinyin:"shàng ge yuè", meaning_ar:"الشهر اللي فات", audio:"audio/hsk2/l01/v105.wav",
      example:{ hanzi:"上个月我很忙。", pinyin:"shàng ge yuè wǒ hěn máng", meaning_ar:"الشهر اللي فات كنت مشغول." } },
    { id:"v106", hanzi:"以后", pinyin:"yǐhòu", meaning_ar:"بعد كده / في المستقبل", audio:"audio/hsk2/l01/v106.wav",
      example:{ hanzi:"以后我想去日本。", pinyin:"yǐhòu wǒ xiǎng qù rìběn", meaning_ar:"بعد كده عايز أروح اليابان." } },
    { id:"v107", hanzi:"过", pinyin:"guo", meaning_ar:"أداة الخبرة (سبق و...)", audio:"audio/hsk2/l01/v107.wav",
      example:{ hanzi:"我去过中国。", pinyin:"wǒ qù guo zhōngguó", meaning_ar:"سبق ورحت الصين." } },
    { id:"v108", hanzi:"刚才", pinyin:"gāngcái", meaning_ar:"من شوية / لسه من دقيقة", audio:"audio/hsk2/l01/v108.wav",
      example:{ hanzi:"刚才他来了。", pinyin:"gāngcái tā lái le", meaning_ar:"من شوية هو جه." } }
  ],

  grammar: {
    title_ar: "استخدام 了 للدلالة على الماضي",
    explanation_ar: "في الصينية مفيش تصريف للفعل زي العربي أو الإنجليزي، فبنستخدم 了 بعد الفعل عشان نقول إن الحدث خلص. وفيه فرق بينها وبين 过 اللي بتدل على 'الخبرة' (إنك جربت حاجة قبل كده) مش وقت محدد.",
    pattern: "الفاعل + الفعل + 了 + المفعول",
    examples: [
      { hanzi:"他去了北京。", pinyin:"tā qù le běijīng", meaning_ar:"هو راح بكين." },
      { hanzi:"我去过北京，但去年没去。", pinyin:"wǒ qù guo běijīng, dàn qùnián méi qù", meaning_ar:"سبق ورحت بكين، بس السنة اللي فاتت ماروحتش." }
    ]
  },

  practiceSentences: [
    { id:"p101", type:"reorder", hanzi:"我 昨天 了 去 学校", correctOrder:["我","昨天","去","了","学校"], meaning_ar:"أنا رحت المدرسة إمبارح." }
  ],

  quiz: [
    { id:"q101", question_ar:"إيه معنى 了 في الجملة؟", vocabId:"v101",
      options:["فعل ماضي مساعد","اسم إشارة","حرف جر","ضمير"], correctIndex:0 },
    { id:"q102", question_ar:"الفرق بين 了 و 过 إيه؟", vocabId:"v107",
      options:["مفيش فرق","过 للخبرة، 了 لاكتمال الفعل","过 للمستقبل","了 بس للأسئلة"], correctIndex:1 },
    { id:"q103", question_ar:"'السنة اللي فاتت' بالصيني؟", vocabId:"v104",
      options:["明年","今年","去年","以后"], correctIndex:2 }
  ],
...
/* ------------------ الدرس 2: المقارنة ------------------ */
{
  id: 2, level: "HSK2", title: "المقارنة", title_cn: "比较", icon: "⚖️",
  words: [
...
{
  id: 3, level: "HSK2", title: "المشاعر والحالة النفسية", title_cn: "感情", icon: "😊",
  words: [
  ...
  grammar: {
    ...
    examples: [ { hanzi:"他难过了。", pinyin:"tā nánguò le", meaning_ar:"هو زعل (حصل تغيير في حالته)." } ]
  },
  practiceSentences: [
...
{
  id: 4, level: "HSK2", title: "الجسم والصحة", title_cn: "身体健康", icon: "🩺",
  words: [
  ...
  grammar: {
    ...
    pattern: "عضو الجسم + 疼",
    examples: [ { hanzi:"我牙疼。", pinyin:"wǒ yá téng", meaning_ar:"سني بتوجعني." } ]
  },
  practiceSentences: [
...
{
  id: 5, level: "HSK2", title: "الهوايات ووقت الفراغ", title_cn: "爱好", icon: "🎨",
  words: [
  ...
  grammar: {
    ...
    examples: [ { hanzi:"他跑得很快。", pinyin:"tā pǎo de hěn kuài", meaning_ar:"هو بيجري بسرعة." } ]
  },
  practiceSentences: [
...
{
  id: 6, level: "HSK2", title: "المواصلات والسفر", title_cn: "交通", icon: "🚄",
  words: [
  ...
  grammar: {
    ...
    examples: [ { hanzi:"我坐火车，他开车。", pinyin:"wǒ zuò huǒchē, tā kāichē", meaning_ar:"أنا راكب القطر، هو سايق عربيته." } ]
  },
  practiceSentences: [
  ...
  cultureCard: {
    ...
    body_ar:"شبكة القطارات فائقة السرعة في الصين (高铁) هي الأكبر في العالم، وبتوصل سرعات تفوق 300 كم/ساعة. المشروع ده بالنسبالهم مش بس وسيلة مواصلات، لكنه رمز لتقدم البلد التكنولوجي السريع في العقود الأخيرة. برضو ثقافة 'مشاركة العجلة' (共享单车) - عجل ملونة منتشرة في كل شارع تقدر تفتحها بتطبيق موبايل - بقت جزء أساسي من حياة المدن الصينية اليومية.",
    relatedTo:"daily_life"
  }
},
...
{
  id: 7, level: "HSK2", title: "الأفعال المساعدة", title_cn: "能愿动词", icon: "🗝️",
  words: [
    ...
    { id:"v708", hanzi:"不用", pinyin:"búyòng", meaning_ar:"مش محتاج / مفيش داعي", audio:"audio/hsk2/l07/v708.wav",
      example:{ hanzi:"不用谢。", pinyin:"búyòng xiè", meaning_ar:"مفيش داعي للشكر." } }
  ],
  grammar: {
    title_ar: "الفرق بين 会 و 能 و 可以",
    explanation_ar: "الثلاثة بيترجموا 'يقدر' بالعربي، بس معانيهم مختلفة: 会 = مهارة اتعلمتها، 能 = قدرة جسدية أو ظرفية، 可以 = إذن اجتماعي أو إمكانية.",
    pattern: "الفاعل + 会/能/可以 + الفعل",
    examples: [ { hanzi:"我会游泳，但今天不能游。", pinyin:"wǒ huì yóuyǒng, dàn jīntiān bù néng yóu", meaning_ar:"أنا بعرف أعوم، بس النهارده مقدرش أعوم." } ]
  },
  practiceSentences: [
  ...
  cultureCard: {
    ...
    body_ar:"لما صيني يقولك 你应该... (المفروض إنك...)، غالبًا مش بيديك أمر مباشر، لكنه بيقدملك اقتراح مهذب وغير ملزم، خصوصًا لو الفارق في السن أو المكانة الاجتماعية موجود. الثقافة الصينية بتميل للتواصل غير المباشر (委婉) عشان تحافظ على 面子 (وش/كرامة) الطرفين. عشان كده هتلاقي 应该 بتتقال بنبرة ناعمة.",
    relatedTo:"grammar"
  }
},
...
{
  id: 8, level: "HSK2", title: "المكالمات والمواعيد", title_cn: "打电话", icon: "📞",
  words: [
  ...
  grammar: {
    ...
    examples: [ { hanzi:"他给我打电话了。", pinyin:"tā gěi wǒ dǎ diànhuà le", meaning_ar:"هو اتصلي بيا." } ]
  },
  practiceSentences: [
  ...
  cultureCard: {
    ...
    body_ar:"في السياق الرسمي أو مع الأكابر، الوصول قبل الميعاد بـ5-10 دقايق مش مجرد لطف، لكنه علامة احترام أساسية. التأخير (迟到) في اجتماع عمل أو مقابلة رسمية ممكن يتفهم إنه استخفاف بوقت الطرف التاني، حتى لو السبب بسيط. من ناحية تانية، في العلاقات الشخصية القريبة، المرونة في المواعيد أكتر عادي. الفرق ده أساس فكرة أوسع اسمها 关系 (العلاقات) اللي بتحدد إزاي تتعاملي مع كل حد حسب قربه منك.",
    relatedTo:"daily_life"
  }
},
...
{
  id: 9, level: "HSK2", title: "السبب والنتيجة", title_cn: "因果关系", icon: "🔗",
  words: [
  ...
  grammar: {
    ...
    examples: [ { hanzi:"因为我感冒了，所以没去上班。", pinyin:"yīnwèi wǒ gǎnmào le, suǒyǐ méi qù shàngbān", meaning_ar:"لأني اتبردت، عشان كده ماروحتش الشغل." } ]
  },
  practiceSentences: [
...
{
  id: 10, level: "HSK2", title: "التخطيط للمستقبل والتكرار", title_cn: "计划", icon: "📅",
  words: [
  ...
  grammar: {
    ...
    examples: [ { hanzi:"电影快要开始了。", pinyin:"diànyǐng kuàiyào kāishǐ le", meaning_ar:"الفيلم هيبدأ قريب." } ]
  },
  practiceSentences: [
  ...
  cultureCard: {
    ...
    body_ar:"لما تسألي صديقة صينية عن خططها للمستقبل (计划)، هتلاحظي إن كتير من القرارات الكبيرة - الدراسة، الشغل، حتى الزواج - بتتاخد بمشاركة العيلة، مش قرار فردي بحت. ده جزء من قيمة 孝 (بر الوالدين واحترامهم)، وبتمتد لفكرة إن نجاح الفرد هو في الأساس نجاح للعيلة كلها. عشان كده لو سألتي حد صيني 'إيه خطتك؟' ممكن تلاقيه بيقولك 'لسه بستشير أهلي' حتى لو هو كبير في السن ومستقل ماديًا.",
    relatedTo:"daily_life"
  }
}
